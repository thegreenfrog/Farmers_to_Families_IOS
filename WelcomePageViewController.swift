...
class WelcomePageViewController: UIPageViewController {
    ...
    private(set) lazy var orderedViewControllers: [UIViewController] = {
        return [self.newColoredViewController("FarmRegister"),
            self.newColoredViewController("Welcome"),
            self.newColoredViewController("ConsumerRegister")]
    }()
    
    private func newColoredViewController(name: String) -> UIViewController {
        switch name {
        case "FarmRegister":
            return FarmerRegisterViewController()
        case "Welcome":
            return RegisterViewController()
        case "ConsumerRegister":
            return ConsumerRegisterViewController()
        default:
    ...
    override func viewDidLoad() {
        ...
        if UIDevice.currentDevice().userInterfaceIdiom == .Phone {
            backgroundView.image = UIImage(named: "vegetable-table-phone.jpg")
        } else {
            backgroundView.image = UIImage(named: "vegetable-table-ipad.jpg")
        }
